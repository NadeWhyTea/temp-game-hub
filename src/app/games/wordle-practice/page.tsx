...
export default function WordlePractice() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Wordle Practice</h1>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">Practice Mode Under Development</h2>
            <p className="text-gray-300 mb-6">
              Improve your Wordle skills with unlimited practice and detailed statistics. Features coming soon:
            </p>
            <ul className="text-gray-300 text-left max-w-md mx-auto mb-6 space-y-2">
              ...
              <li>• Skill tracking and improvement</li>
